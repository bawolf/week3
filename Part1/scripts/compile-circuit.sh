...
# echo "Compiling TestInputAllowed.circom..."

# # compile circuit

# circom TestInputAllowed.circom --r1cs --wasm --sym -o .
# snarkjs r1cs info TestInputAllowed.r1cs

# # Start a new zkey and make a contribution

# snarkjs groth16 setup TestInputAllowed.r1cs powersOfTau28_hez_final_10.ptau circuit_0000.zkey
